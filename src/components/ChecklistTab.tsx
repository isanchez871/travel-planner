        ...
        <div className="relative p-6 md:p-8">
          ...
          <div className="relative grid gap-6 md:grid-cols-[1fr_360px] md:items-end">
            <div>
              ...
              <h2 className="max-w-3xl text-3xl font-semibold tracking-tight md:text-5xl">Preparación antes de salir</h2>
              <p className="mt-4 max-w-2xl text-sm leading-6 text-stone-300 md:text-base">Documentación, moto, equipamiento, electrónica y último check para salir sin cabos sueltos.</p>
            </div>
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between border-b border-stone-100 bg-stone-50 px-6 py-4">
                ...
                <span className="rounded-full bg-white px-3 py-1 text-sm font-semibold text-stone-500 shadow-sm">
